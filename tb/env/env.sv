class env#(int DATA_WIDTH = 8, int ADDR_WIDTH = 4) extends uvm_env;
    ...
    function void build_phase(uvm_phase phase);
        ...
        cov = coverage#(DATA_WIDTH)::type_id::create("cov", this); 
    endfunction
    ...
    function void connect_phase(uvm_phase phase);
        ...
        r_agent.r_driver.read_control_port.connect(cov.read_control_imp);
        w_agent.w_driver.write_control_port.connect(cov.write_control_imp);
    endfunction
